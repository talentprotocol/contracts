...
import { DNSProver, SignedSet } from '@ensdomains/dnsprovejs';
...
const hexEncodeBuffer = (buffer: Buffer) =>
...
async function main() {
  ...
  const dnsRegistrarContract = new ethers.Contract(
    dnsRegistrarAddress,
    DnsRegistrar.abi,
    owner
  );
  ...
  // talentprotocol.com for mainnet
