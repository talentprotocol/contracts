...
import * as manifestUtil from '../migrations/util/load-manifest.js';
import * as graphTsUtil from '../migrations/util/versions.js';
export const assertManifestApiVersion = async (manifestPath, minimumApiVersion) => {
    const manifest = await manifestUtil.loadManifest(manifestPath);
    const lessThanMinimumVersion = (manifestApiVersion) => semver.lt(manifestApiVersion, minimumApiVersion);
...
export const assertGraphTsVersion = async (sourceDir, minimumGraphTsVersion) => {
    let graphTsVersion;
    try {
