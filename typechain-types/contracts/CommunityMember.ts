...
export interface CommunityMemberInterface extends utils.Interface {
  functions: {
...
export interface CommunityMember extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CommunityMemberInterface;
