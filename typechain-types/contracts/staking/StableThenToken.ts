...
export interface StableThenTokenInterface extends utils.Interface {
  functions: {
...
export interface StableThenToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StableThenTokenInterface;
