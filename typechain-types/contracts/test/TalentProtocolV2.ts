...
export interface TalentProtocolV2Interface extends utils.Interface {
  functions: {
...
export interface TalentProtocolV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TalentProtocolV2Interface;
  ...
  functions: {
    ...
    initialize(
      startingAmount: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
