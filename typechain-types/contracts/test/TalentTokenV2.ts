...
export interface TalentTokenV2Interface extends utils.Interface {
  functions: {
    "DEFAULT_ADMIN_ROLE()": FunctionFragment;
    "MAX_SUPPLY()": FunctionFragment;
    "ROLE_MINTER()": FunctionFragment;
    "ROLE_TALENT()": FunctionFragment;
    "addNewMinter(address)": FunctionFragment;
...
export interface TalentTokenV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TalentTokenV2Interface;
